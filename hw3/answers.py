...
def part3_gan_hyperparams():
    ...
    hypers['discriminator_optimizer'] = dict(type='Adam', weight_decay=0.015, betas=(0.5, 1 - 1e-3), lr=2e-4)
    hypers['generator_optimizer'] = dict(type='Adam', weight_decay=0.015, betas=(0.5, 1 - 1e-3), lr=2e-4)
